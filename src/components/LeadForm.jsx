...
function LeadForm() {
  useEffect(() => {
    // CRM Form Script with Proxy
    (function () {
      var u = '65e86ef8-8fac-4075-8dc8-cf18b1fd5f2c';
      var a = '/api/crm-form'; // Use proxy endpoint
      var c = document.getElementById('crm-lead-form-' + u);

      if (!c) return; // Exit if container not found
      ...
      fetch(a)
        ...
        .then(function (cfg) {
          ...
          f.forEach(function (fld) {
            ...
            var isPhone = fld.type === 'tel' || (fld.fieldType === 'standard' && fld.standardField === 'phone');
          ...
          // Phone mask
          var phoneInputs = document.querySelectorAll('#crm-f-' + u + ' input[data-phone-mask="true"]');
          ...
          document.getElementById('crm-f-' + u).addEventListener('submit', function (e) {
            ...
            var cb = document.getElementById('crm-consent-' + u);
            ...
            var btn = document.getElementById('crm-btn-' + u);
            ...
            fetch(a, {
              ...
              .then(function (res) {
                ...
                var ok = document.getElementById('crm-ok-' + u);
  ...
  return (
    ...
    >
      ...
      <div id="crm-lead-form-65e86ef8-8fac-4075-8dc8-cf18b1fd5f2c" className="mx-auto max-w-2xl" />
    </motion.section>
  );
}
